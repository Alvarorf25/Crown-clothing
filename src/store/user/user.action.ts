...
export type SignUpSuccess = ActionWithPayload<
    USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData; additionalDetails: AdditionalInformation }
>;
...
export const singUpFailed = withMatcher((error: Error): SingUpFailed => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error));
